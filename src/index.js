...
function setDelay(difficulty) {
  ...
  else if (difficulty == "hard") return randomInteger(600, 1200) // This is being used from previous code to show the difficutly here as the highest using this range
}
...
*/
function startGame(){
  clearScore(); // This is also something that wasnt mention but decided to implement to have the npm test pass it
  startTimer();
  setEventListeners(); // This wasnt not passing the npm test. Went to look back at the instructions and did not mention needing to add this.
  setDuration(10);
  showUp();
